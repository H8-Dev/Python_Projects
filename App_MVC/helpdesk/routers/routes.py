...
user_bp.add_url_rule('/usuarios', view_func=UsuarioController.atualizar, methods=['PUT'])
...
chamado_bp.add_url_rule('/chamados', view_func=ChamadoController.atualizar, methods=['PUT'])
